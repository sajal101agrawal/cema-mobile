...
const EmptyCartComponent = ({ isLoading = false }) => {
		...
		<View style={{ flex: 1, justifyContent: 'center', paddingHorizontal: moderateScale(15) }}>
			<View style={{ flex: 0.85, justifyContent: 'center' }}>
				...
				<View style={{ marginTop: moderateScale(15) }}>
					<Text style={{ fontFamily: Fonts.POPPINS_BOLD, fontSize: moderateScale(22), color: Colors.SECONDARY_COLOR }}>Your Cart Is Empty!</Text>
				</View>
				<View style={{}}>
...
export default memo(EmptyCartComponent);
